...
```{r, spatial_figures_mean, eval = TRUE}
temp <- cbind(uk,
              R_UA,
              R_grid,
              R_gam)
...
<<<<<<< HEAD
ggplot(temp, aes(fill = R)) +
  ggplot2::geom_sf(temp,aes(fill = R)) +
  ggtitle('Simulated Rt - UA')+
=======
```{r}
dim(temp)
dim(temp2)
ggplot(temp3, aes(fill = R)) +
  ggplot2::geom_sf() +
  ggtitle('Simulated Rt')+
>>>>>>> 787b1dd35b8b212d0ff5dcbd8ea66314bb64c4a5
  scale_fill_viridis_c(limits = c(0, 3),name = 'R',option = 'H') 

```


ggplot(temp, aes(fill = UA_Mean)) +
  ggplot2::geom_sf() +
...
ggplot(temp, aes(fill = grid_Mean)) +
  ggplot2::geom_sf() +
...
temp$UA_cvL <- log10(temp$UA_Std/temp$UA_Mean)
temp$grid_cvL <- log10(temp$grid_Std/temp$grid_Mean)
temp$gam_cvL <- log10(temp$gam_Std/temp$gam_Mean)

# range(c(temp$UA_cvL ,
#         temp$grid_cvL ,
#         temp$gam_cvL))

ggplot(temp, aes(fill = UA_cvL)) +
  ggplot2::geom_sf() +
  ggtitle('CV of EpiEstim Rt - UA')+
  scale_fill_viridis_c(limits = c(-2.1,0),name = 'Cv (R)',option = 'H') 

ggplot(temp, aes(fill = grid_cvL)) +
  ggplot2::geom_sf() +
