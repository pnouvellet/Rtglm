...
g <- ggplot(temp, aes(fill = grid_Mean)) +
  ggplot2::geom_sf() +
...
g <- ggplot(temp, aes(fill = gam_Mean)) +
  ggplot2::geom_sf() +
  ggtitle('GAM Rt') +
  scale_fill_viridis_c(limits = c(0, 3),name = 'R',option = 'H')  
print(g)
...
g <- ggplot(temp, aes(fill = gam_cvL)) +
  ggplot2::geom_sf() +
